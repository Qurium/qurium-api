...
public class NlQueryRepository implements PanacheRepositoryBase<NlQuery, UUID> {
    ...
    public UUID store(DatabaseConnection connection, String question, String generatedSql, String resultSnapshot,
                      String explanation, NlQueryStatus status, String errorMessage) {
